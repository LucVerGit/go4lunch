...
public class Restaurant {
     ...
     * a {@link NearbySearch.Result} existing instance.
     *
     * @param result a {@link NearbySearch.Result} which was returned by
    ...
    /**
     * Constructor which returns a {@link Restaurant} new instance based on
     * a {@link Details.Result} existing instance.
     *
     * @param result a {@link Details.Result} which was returned by the
     *               Google Places Details API.
     */
    public Restaurant(@NonNull Details.Result result) {
        mName = result.getName();
        mPlaceId = result.getPlaceId();
        mVicinity = result.getVicinity();
        mLatitude = result.getGeometry().getLocation().getLat();
